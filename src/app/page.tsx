...
export default function Home() {
  return (
    <>
      {/* Hero con fondo degradé (cubre detrás del header) */}
      <div className="relative -mt-[72px] overflow-hidden pt-[72px] md:-mt-[96px] md:pt-[96px]">
        <div className="absolute inset-0 -z-10 bg-[radial-gradient(120%_60%_at_80%_-2%,#e7eef6_0%,#faf8f5_45%,#f6ece4_100%)]" />
      ...
      {/* El diferencial (verificación IA) */}
      <Diferencial />
